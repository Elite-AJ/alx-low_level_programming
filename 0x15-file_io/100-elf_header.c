...
/**
 * print_class - Printd the class of an ELF header
 * @e_ident: A pointer
 */
...
/**
 * print_type - printd the type of an ELF header
 * @e_type: ELF type
...
/**
 * main - Displays info embedded in the ELF header
 * at the start of the ELF file
 * @argc: No of args supplied to the program
 *
 * @argv: Array of pointers and arguments
 * Return: 0 on success
 * Description: If func fail or not an ELF file, exit code 98
 */
